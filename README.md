...
| Раздел | Содержание |
|--------|------------|
| Возможности | Список всех фич (path, internal, объединение, сканирование, конфиг) |
| Требования | Python 3.8+, Qt, pyyaml |
| Установка | Клонирование, виртуальное окружение, зависимости |
| Конфигурация | Пример config.yaml с комментариями |
| Использование | Базовый запуск, флаги, режимы |
| Структура проекта | Описание каждого файла |
| Как это работает | Пошаговое описание процесса |
| Аргументы командной строки | Таблица с описанием всех аргументов |
| Особенности | Подробно про path, internal, объединение |
| Возможные ошибки | Решения частых проблем |
